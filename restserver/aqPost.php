  ...
  class aqPost {
   ...
   // Insert sensor data
    public function create() {
          // Create query
          $query = 'INSERT INTO '. $this->table .' SET site_id = :site_id, sensor_id = :sensor_id, data_date = :data_date, data_time = :data_time, temperature = :temperature, humidity = :humidity,pressure=:pressure,oxidised=:oxidised,reduced=:reduced, nh3=:nh3,lux=:lux,pm1=:pm1,pm25=:pm25,pm10=:pm10';
